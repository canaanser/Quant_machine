...
# ===== 指数池（2026-08-28 小二陈） =====
# 探测确认：stockdb 收录宽基/板块指数（无传统三大指数——上证000001被平安银行占用、
# 深成/创业板未收录；指数不需复权故 dump 复权键拿不到，日k表有）
# 000016上证50(大盘) / 000905中证500(中盘) / 000852中证1000(小盘) / 000688科创50
# 扫描后进 pattern_history，供"大盘企稳"过滤（深跌信号 + 指数状态验证）
SCAN_TICKERS_INDEX = [
    '000016',   # 上证50（大盘基准）
    '000905',   # 中证500（中盘）
    '000852',   # 中证1000（小盘）
