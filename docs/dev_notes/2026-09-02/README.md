...
1. **[P0]** 布林带实验（老板点名下一项）——学的那篇知乎文要点：上轨≠卖点/下轨≠买点/带宽看状态/配趋势线+形态
2. **[P1]** 门 + 止损组合测试（趋势门定风险、止损兜底；现在纯门控回撤 -24%~-40%）
3. **[P2]** 84池 月线门 vs 周线门取舍（贪 vs 稳）；旧卖(--old-sell)与趋势门叠加
4. **[P3]** DECISIONS §4.6 待办：王文五滚动池 + 底背离反转组合
