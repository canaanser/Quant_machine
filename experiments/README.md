...
> 📌 备注（2026-09-05）：`2026-09-02/` 目录内文件的**落盘/提交时间多为 09-04**（如 tech300_oos/verify_ww_gate 等 09-04 晚 21:56~23:57 落盘）——目录名沿用实验批次日 09-02，不改名只说明。实验结论按实际日期记在 `docs/dev_notes/2026-09-04/`。
