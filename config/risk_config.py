...
MAX_TOTAL_POSITION_RATIO = 0.70      # 总仓位上限（%总资产）；2026-08-30 老板：分散池回撤控制靠总仓上限（非个股止损）——留30%现金缓冲
STOP_LOSS_AGGRESSIVE = 0.20           # 妖股硬止损线（7%亏损）
STOP_LOSS_GENTLE = 0.30               # 蓝筹软止损线（10%亏损）
PROFIT_TAKE_THRESHOLD = 0.50          # 止盈线（30%盈利）
BASE_POSITION_RATIO = 0.30            # 基础仓位比例=仓位上限斜率（2026-08-30 老板：0.80→0.30，配合评分²映射，30%需满分）
