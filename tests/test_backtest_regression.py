...
# 2026-08-28 更新：回测读表改造（扫描器预扫 pattern_history，回测查表替代每天现扫）后新基线。
# 旧基线（每天现扫）：0.08179 / 0.05337 / 0.32277 / -0.26402 / 125
# 新基线信号更干净（波段内扫描+先验strength，无未来函数）：收益+29%、夏普+13%、回撤收窄、交易更少。
BASELINE = {
    "total_return": 0.105556,
    "annual_return": 0.068624336103513,
    "sharpe": 0.365152446271913,
    "max_drawdown": -0.247919186799489,
    "trades": 80,
}
