...
- **本节（§一~§九）为真 2026-09-02 内容**（提交 8250d0e/596430a/4b11ac3，09-02 当天）。
- 原文件 §十~§十五（标签分治/纯金叉/止损规范化/8只新票/盲选/王文五）git 提交日期全在 **09-04** → 已迁移至 `docs/dev_notes/2026-09-04/README.md`。
- 原文件 §十六~§十七（架构 P1/P2/回退）git 提交日期在 **09-05 凌晨** → 已迁移至 `docs/dev_notes/2026-09-05/README.md`。
- 原因：压缩后日期记账错乱，跨日补丁全堆在 09-02 名下；老板 2026-09-05 指示按 git 日期拆档。节号沿用原编号以便对照。
